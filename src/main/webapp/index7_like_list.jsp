					...
					<div class="inner">
						<div class="part01">
							...
							<div class="container mt-3"
								...
								<h2 class="text-light">좋아요 목록</h2>
								<p class="text-light">이전에 좋아요 한 곡 목록을 보여줍니다. 원하는 곡을 보관할 수 있습니다.</p>
								<br>
								<table class="table table-bordered text-light">
									...
									<tbody id="myTable" class="text-light">
										<div id="accordion">
											<tr>
												<td>Someday My Prince Will Come - Piano (Bill Evans Trio)</td>
												<td>
													<button onclick="location.href='index5_multi_akbo_bill_piano.jsp' ">
											...
											<tr>
												<td>Someday My Prince Will Come - Bass (Bill Evans Trio)</td>
												<td>
													<button onclick="location.href='index5_multi_akbo_bill_bass.jsp' ">
														<i class="fas fa-music"> 악보조회</i>
													</button>
													<button>
											...
											<tr>
												<td>Equinox - Piano (John Coltrane)</td>
												<td>
													<button>
														<i class="fas fa-music"> 악보조회</i>
													</button>
											...
											<tr>
												<td>Equinox - Bass (John Coltrane)</td>
												<td>
													<button>
														<i class="fas fa-music"> 악보조회</i>
													</button>
											...
											<tr>
												<td>Equinox - Saxophone (John Coltrane)</td>
												<td>
													<button onclick="location.href='index5_multi_akbo_john_saxophone.jsp' ">
														<i class="fas fa-music"> 악보조회</i>
													</button>
													<button>
														<i class="fas fa-trash">삭제</i>
