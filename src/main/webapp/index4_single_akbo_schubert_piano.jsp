...
<script type="text/javascript">
	var aAudio = new Audio(
			'assets/audio/Piano Sonata in C minor, D.958 (Schubert).wav');
	var a = false;
								...
								<table class="table table-bordered text-light">
									<thead>
										<tr>
											...
											<th colspan='3'>Piano Sonata in C minor, D.958 (Schubert)</th>

										</tr>

										<tr>
											<td><img class="akbo" src="assets/img/Piano Sonata in C minor, D.958 (Schubert)-1.jpg"
												width=900px, height=1100px></td>


											<td><a class="btn"
												href="assets/pdf/Piano Sonata in C minor, D.958 (Schubert)-1.pdf"
