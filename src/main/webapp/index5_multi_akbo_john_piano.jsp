...
<script type="text/javascript">
	var aAudio = new Audio(
			'assets/audio/Equinox - John Coltrane - Piano.wav');
	var a = false;
								...
								<table class="table table-bordered text-light">
									<thead>
										<tr>
											...
											<th colspan='3'>Equinox - Piano (John Coltrane Trio)</th>

										</tr>

										<tr>
											<td><img class="akbo" src="assets/img/Equinox - Piano (John Coltrane Trio)-1.jpg"
												width=900px, height=1100px></td>


											<td><a class="btn"
												href="assets/pdf/Equinox - Piano (John Coltrane Trio)-1.pdf"
