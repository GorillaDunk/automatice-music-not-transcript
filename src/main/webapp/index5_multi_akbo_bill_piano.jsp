...
<script type="text/javascript">
	var aAudio = new Audio(
			'assets/audio/Someday My Prince Will Come - Piano (Bill Evans Trio) - Cut.wav');
	var a = false;
								...
								<table class="table table-bordered text-light">
									<thead>
										<tr>
											...
											<th colspan='3'>Someday My Prince Will Come - Piano (Bill Evans Trio)</th>

										</tr>

										<tr>
											<td><img class="akbo" src="assets/img/Someday My Prince Will Come - Piano (Bill Evans Trio)-1.jpg"
												width=900px, height=1100px></td>

											<td><a class="btn"
												href="assets\pdf\Someday My Prince Will Come - Bass (Bill Evans Trio)-1.pdf"
