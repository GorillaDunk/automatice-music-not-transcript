...
<script type="text/javascript">
	var aAudio = new Audio(
			'assets/audio/Sweet Child O Mine_Intro (Guns N Roses).wav');
	var a = false;
								...
								<table class="table table-bordered text-light">
									<thead>
										<tr>
											...
											<th colspan='3'>Sweet Child O' Mine_Intro (Guns n' Roses)</th>

										</tr>

										<tr>
											<td><img class="akbo" src="assets/img/Sweet Child O' Mine_Intro (Guns n' Roses)-1.jpg"
												width=900px, height=1100px></td>


											<td><a class="btn"
												href="assets\pdf\Sweet Child O' Mine_Intro (Guns n' Roses)-1.pdf"
