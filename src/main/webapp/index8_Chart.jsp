														...
														<div class="card-header bg-dark" id="headingOne">
															<h2 class="mb-0">
																<button class="btn btn-link text-light" type="button"
																	...
																	Piano Sonata in C minor, D.958 (Schubert) </button>
															</h2>
														</div>
												...
												<td colspan=2>
													<ul class="pagination" style="margin: 0 0 0 350px;">
														...
														<li class="page-item active"><a class="page-link"
															href="#">1</a></li>
														<li class="page-item"><a class="page-link" href="index8_Chart2.jsp">2</a></li>
...
<script>
    ...
    new Morris.Line({
    	  ...
    	  data: [
    	    ...
    	    { date: '2021-08-26', value: 58 }, 
    	    { date: '2021-08-27', value: 52 },
    	    { date: '2021-08-28', value: 60 },
    	    { date: '2021-08-29', value: 73 },
    	    { date: '2021-08-30', value: 68 },
/*     	    { date: '2021-08-31',  value: 68 }, */
